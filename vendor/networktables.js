...
window.NetworkTables = function(host) {
    ...
    */
	...
	this.removeGlobalListener = function(f) {
		var i = globalListeners.indexOf(f);
		if(i != -1) {
			globalListeners.splice(i, 1);
		}
	};
	this.removeRobotConnectionListener = function(f) {
		var i = robotConnectionListeners.indexOf(f);
		if(i != -1) {
			robotConnectionListeners.splice(i, 1);
		}
	};
	this.removeWsConnectionListener = function(f) {
		var i = connectionListeners.indexOf(f);
		if(i != -1) {
